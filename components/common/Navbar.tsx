...
export default function Navbar() {
  return (
    ...
    {/* desktop navbar */}
    <div className=' hidden dark:bg-card bg-secondary px-3 md:grid grid-cols-12 md:items-center 
  ...
  <div className=' fixed w-full bottom-0 md:hidden dark:bg-card bg-secondary px-3 grid grid-cols-12 
                  md:items-center md:justify-center py-2 '>

  <div className='flex col-span-4 items-center gap-x-2 text-primary'> 
